<template>
  <div class="About">
    ...
    <StaticCard>
      {{
        $t(
          '当サイトは新型コロナウイルス感染症 (COVID-19) に関する最新情報を提供するために、川井(個人)が開設したものです。'
        )
      }}<br />
      <br />
      {{
        $t(
          '和歌山県による公式情報と客観的な数値をわかりやすく伝えることで、和歌山県にお住まいの方や、和歌山県内に拠点を持つ企業の方、和歌山県を訪れる方が、現状を把握して適切な対策を取れるようにすることを目的としています。'
        )
      }}
    </StaticCard>
    <StaticCard>
    ...
    <StaticCard>
      ...
      <p>
        {{
          $t(
            '当サイトに掲載されている情報の正確性については万全を期していますが、和歌山県は利用者が当サイトの情報を用いて行う一切の行為について責任を負うものではありません。'
          )
        }}
      </p>
      <p>
